...
const routes = [
    ...
    { path: '/admin/instructors', component: () => import('../views/InstructorManagement.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
    { path: '/admin/courses', component: () => import('../views/CourseManagement.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
    { path: '/admin/enrollments', component: () => import('../views/EnrollmentManagement.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
    { path: '/admin/reviews', component: () => import('../views/ReviewModeration.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
    { path: '/admin/qna', component: () => import('../views/QnAModeration.vue'), meta: { requiresAuth: true, requiresAdmin: true } },
